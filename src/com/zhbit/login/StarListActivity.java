...
import com.zhbit.adapter.WaterFallAdater;
...
public class StarListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        int margin = getResources().getDimensionPixelOffset(R.dimen.activity_starlist_margin);
...
//        	
//        });
        WaterFallAdater adapter = new WaterFallAdater(this, R.id.star_image, urls);
